...
st.bar_chart(df_liga.sort_values(by='total', ascending=False), x='entry_name', y='total')
...
st.bar_chart(df_liga_bps5100.sort_values(by='total', ascending=False), x='entry_name', y='total')
